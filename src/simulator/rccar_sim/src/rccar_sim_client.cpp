/* 
 * rccar_sim_client.cpp
 * 
 * Created on: Jul 25, 2018 23:42
 * Description: 
 * 
 * Copyright (c) 2018 Ruixiang Du (rdu)
 */ 

#include "rccar_sim/rccar_sim_client.hpp"
...
void RCCarSimClient::SetCarDrivingVel(float cmd)
{
	// add limits to speed
